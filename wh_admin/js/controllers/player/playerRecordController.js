app.controller('playerRecordController', ['$scope', '$http', '$state', '$modal', 'request', 'dialog',
    function ($scope, $http, $state, $modal, request, dialog) {
        ...
        function searchByDataAction() {
            ...
            //调用接口请求
            request.request('/data/playerdata', cond, true)
                .then(function (data) {
        ...
        // request.request('/data/playerdata_detail', {begin:'2017-10-15',end:'2017-10-16',pid:'205406'}, true)
        //     .then(function (data) {
        //         console.log(data);
        //         $scope.players = data.data !== null ? data.data : [];
        //         $scope.pageId = data.page.id;
