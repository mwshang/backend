app.controller('agentBonusInListDailyController', ['$scope', '$http', '$state', '$stateParams', '$timeout', 'request', 'dialog',
    function ($scope, $http, $state, $stateParams, $timeout, request, dialog) {
        ...
        function searchAction(cond) {
            ...
            request.request('/user/bonus_v2', cond, true)
                .then(function (data) {
                    console.log(data);
                    $scope.bonusIn = data.data.bonusIn !== null ? data.data.bonusIn : [];
